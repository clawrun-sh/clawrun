/**
 * Cloud provider brand icons (Simple Icons, 24×24 viewBox).
...
function CloudflareLogo({ size, className }: LogoProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}>
...
const PROVIDER_LOGOS: Record<string, React.ComponentType<LogoProps>> = {
  vercel: VercelLogo,
