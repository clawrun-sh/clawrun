...
import type { RuntimeToolInfo, CliToolInfo } from "@clawrun/agent";
import { IconTool, IconCloudOff } from "@tabler/icons-react";
...
export default function ToolsPage() {
  const { data, loading, error } = useApi<ToolsData>("/api/v1/tools");
      ...
      <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-12 text-center">
            <IconCloudOff className="mb-4 size-12 text-muted-foreground" />
            <p className="text-muted-foreground">Sandbox offline — tools unavailable</p>
          </div>
