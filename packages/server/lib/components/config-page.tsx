...
import { Card, CardContent, CardHeader, CardTitle, CardDescription } from "@clawrun/ui/components/ui/card";
import type { AgentConfig } from "@clawrun/agent";
import { IconInfoCircle } from "@tabler/icons-react";

export default function ConfigPage() {
  const { data, loading, error } = useApi<AgentConfig>("/api/v1/config");
