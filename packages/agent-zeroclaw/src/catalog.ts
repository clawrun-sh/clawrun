...
export const PROVIDERS: ProviderInfo[] = [
  ...
  { name: "doubao", displayName: "Doubao (Volcengine)", tier: "specialized" },
  { name: "qianfan", displayName: "Qianfan (Baidu)", tier: "specialized" },
  { name: "telnyx", displayName: "Telnyx", tier: "specialized" },
  { name: "ovhcloud", displayName: "OVHcloud AI Endpoints", tier: "specialized" },
  { name: "opencode-go", displayName: "OpenCode Go", tier: "specialized" },
...
const DEFAULT_MODELS: Record<string, string> = {
  ...
  telnyx: "openai/gpt-4o",
  ovhcloud: "meta-llama/Meta-Llama-3.1-70B-Instruct",
  "opencode-go": "anthropic/claude-sonnet-4.6",
...
const CURATED_MODELS: Record<string, CuratedModel[]> = {
  ...
  doubao: [
    { id: "doubao-pro-latest", label: "Doubao Pro (flagship)" },
    { id: "doubao-lite-latest", label: "Doubao Lite (fast, cost-efficient)" },
  ],
  telnyx: [
    { id: "openai/gpt-4o", label: "GPT-4o via Telnyx" },
    { id: "meta-llama/Meta-Llama-3.1-70B-Instruct", label: "Llama 3.1 70B via Telnyx" },
  ],
  ovhcloud: [
    { id: "meta-llama/Meta-Llama-3.1-70B-Instruct", label: "Llama 3.1 70B (recommended)" },
  ],
  "opencode-go": [{ id: "anthropic/claude-sonnet-4.6", label: "Claude Sonnet 4.6 (recommended)" }],
  bedrock: [
...
export function getModelsFetchEndpoint(
  ...
  const openaiCompatible: Record<string, string> = {
    ...
    telnyx: "https://api.telnyx.com/v2/ai/models",
    ...
    qianfan: "https://aip.baidubce.com/v1/models",
