  ...
  return (
    <div className="my-6 flex flex-col items-center font-mono">
      <StateBox
        icon={Circle}
        label="No Sandbox"
        sub="Initial state or after destroy"
      />
      ...
      <div className="relative">
        ...
        <div className="flex items-center justify-center gap-1.5 pb-1.5 sm:hidden">
          ...
          <span className="text-[10px] font-medium tracking-wide text-dim">
            webhook or cron
          </span>
          <svg
            width="5"
